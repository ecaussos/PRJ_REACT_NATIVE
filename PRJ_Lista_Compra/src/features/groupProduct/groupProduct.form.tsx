...
import { GroupProductActionsProps, GroupProductFilterProps } from './groupProduct.types';

// Função para apresentar os botões de ação - Criar/Pesquisar/Limpar
export function GroupProductActions({
...
}: GroupProductActionsProps): React.JSX.Element {
...
export function GroupProductSearchModal({
...
}: GroupProductFilterProps): React.JSX.Element {
  // -------- MONTAGEM DOS BOTÕES NA TELA -------- //
  return (
    ...
    <Modal visible={visible} animationType="fade" transparent={true} onRequestClose={onClose}>
      <View style={styles.modalOverlay}>
        <View style={styles.modalContent}>
          {/* Titulo do modal */}
          <Text style={styles.modalTitle}>Buscar Grupo</Text>
...
export function GroupProductItem({
  isSystemDefault,
    ...
    <View style={styles.itemCard}>
      <View style={styles.itemInfo}>
        ...
        <View style={styles.actionButtonsContainer}>
          {isSystemDefault ? (
            // Exibe ícone de bloqueio caso seja padrão do sistema
